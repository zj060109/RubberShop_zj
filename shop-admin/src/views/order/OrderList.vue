      ...
      <el-table :data="tableData" v-loading="loading" stripe row-key="id_zj">
        ...
        <el-table-column label="金额" width="110" align="right">
          <template #default="{ row }">
            <span class="price-tag">¥{{ (row.actual_amount_zj ?? 0).toFixed(2) }}</span>
          </template>
        </el-table-column>
...
.price-tag { font-weight: 700; color: var(--primary); font-size: 14px; }

.action-btns { display: flex; gap: 6px; justify-content: center; flex-wrap: wrap; }

.pagination-wrap { display: flex; justify-content: flex-end; margin-top: 20px; padding: 0 20px 20px; }
